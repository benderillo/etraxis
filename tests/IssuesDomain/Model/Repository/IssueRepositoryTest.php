...
class IssueRepositoryTest extends TransactionalTestCase
{
    ...
    public function testSetNumberFieldValue()
    {
        ...
        [$issue6] = $this->repository->findBy(['subject' => 'Development task 6'], ['id' => 'ASC']);
    ...
    {
        /** @var Issue $issue */
        [$issue] = $this->repository->findBy(['subject' => 'Development task 3'], ['id' => 'ASC']);
    ...
    public function testSetIssueFieldValue()
    {
        ...
        [$duplicate1] = $this->repository->findBy(['subject' => 'Development task 3'], ['id' => 'ASC']);
        [$duplicate2] = $this->repository->findBy(['subject' => 'Development task 1'], ['id' => 'ASC']);
