...
class FieldServiceTest extends TransactionalTestCase
{
    ...
    public function testGetNullFieldValue()
    {
        ...
        $value = reset($values);
        self::assertNull($this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetNumberFieldValue()
    {
        ...
        $value = reset($values);
        self::assertSame(5173, $this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetDecimalFieldValue()
    {
        ...
        $value = reset($values);
        self::assertSame('98.49', $this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetStringFieldValue()
    {
        ...
        $value = reset($values);
        self::assertSame('940059027173b8e8e1e3e874681f012f1f3bcf1d', $this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetTextFieldValue()
    {
        ...
        $value = reset($values);
        self::assertSame('Quas sunt reprehenderit vero accusantium.', $this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetCheckboxFieldValue()
    {
        ...
        $value = reset($values);
        self::assertTrue($this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetListFieldValue()
    {
        ...
        $value = reset($values);
        self::assertSame(2, $this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetIssueFieldValue()
    {
        ...
        $value = reset($values);
        self::assertSame($duplicate->id, $this->service->getFieldValue($value, $user));
    }
    ...
    public function testGetDurationFieldValue()
    {
        ...
        $value = reset($values);
        self::assertSame('1:20', $this->service->getFieldValue($value, $user));
    }
