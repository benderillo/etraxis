...
class IssueInfo
{
    ...
    /**
     * @API\Property(type="object", ref=@Model(type=eTraxis\IssuesDomain\Model\API\UserInfo::class), description="Author of the issue.")
     */
    public $author;

    /**
     * @API\Property(type="object", ref=@Model(type=eTraxis\TemplatesDomain\Model\API\State::class), description="Current state.")
     */
    public $state;

    /**
     * @API\Property(type="object", ref=@Model(type=eTraxis\IssuesDomain\Model\API\UserInfo::class), description="Current responsible of the issue.")
     */
    public $responsible;
