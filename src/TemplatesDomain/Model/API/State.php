...
namespace eTraxis\TemplatesDomain\Model\API;
...
class State
{
    ...
    /**
     * @API\Property(type="object", ref=@Model(type=eTraxis\TemplatesDomain\Model\API\Template::class), description="State template.")
     */
    public $template;
